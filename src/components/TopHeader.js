...
export default function TopHeader({ trigger }) {
  ...
  useEffect(() => {
    ...
    return(<div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-800 px-6 py-6 sm:px-3.5 sm:before:flex-1">
      <div
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <p className="text-sm lg:text-lg font-medium leading-6 text-white">
          <strong className="font-semibold">UzCharmExpo-LeatherGoods2024</strong>
